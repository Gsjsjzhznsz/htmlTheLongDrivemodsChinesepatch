...
[![Release](https://img.shields.io/badge/Release-v9.0.0-green)](../../releases/latest)
...
cd htmlTheLongDrivemodsChinesepatch
...
```
htmlTheLongDrivemodsChinesepatch/    # 仓库根目录
├── TLDLoader.dll                     # 中文模组加载器 DLL（供工具下载用）
├── TLDWorkshop.sln                   # 解决方案文件
├── README.md
├── nuget.config
├── src/
